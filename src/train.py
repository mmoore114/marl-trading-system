...
def main():
    ...
    # --- CHANGE: Run for a small number of timesteps to create a checkpoint quickly ---
    target_timesteps = 10000
    logger.info(f"Starting training for {target_timesteps} timesteps to create a checkpoint...")
